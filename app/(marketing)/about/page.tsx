      ...
      <main className="flex-grow">
            ...
            <div>
              ...
              <ul className="space-y-3 text-zinc-400">
                <li className="flex items-start">
                  <svg className="w-6 h-6 text-indigo-400 mr-3 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                  </svg>
                  <span><Icon name="book-marked" size={16} className="inline text-indigo-400 mr-1" /> Curating high-quality technical content, rejecting information noise</span>
                </li>
                <li className="flex items-start">
                  <svg className="w-6 h-6 text-indigo-400 mr-3 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                  </svg>
                  <span><Icon name="code" size={16} className="inline text-indigo-400 mr-1" /> Providing production-ready code examples from real projects</span>
                </li>
                <li className="flex items-start">
                  <svg className="w-6 h-6 text-indigo-400 mr-3 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                  </svg>
                  <span><Icon name="refresh" size={16} className="inline text-indigo-400 mr-1" /> Weekly updates on the latest frameworks, tools, and best practices</span>
                </li>
                <li className="flex items-start">
                  <svg className="w-6 h-6 text-indigo-400 mr-3 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                  </svg>
                  <span><Icon name="target" size={16} className="inline text-indigo-400 mr-1" /> Focusing on modern tech stacks like React, TypeScript, Next.js</span>
                </li>
              </ul>
            </div>
            <div className="bg-zinc-900 rounded-2xl shadow-lg p-8 border border-zinc-800">
              <div className="text-center">
                <div className="w-16 h-16 mx-auto mb-4 rounded-full bg-indigo-500/10 flex items-center justify-center">
                  <Icon name="compass" size={32} className="text-indigo-400" />
                </div>
                <h3 className="text-2xl font-bold text-white mb-2">Codcompass</h3>
                <p className="text-zinc-400">Code + Compass = Developer's Compass</p>
                <p className="text-zinc-500 mt-2">Navigating your technical growth</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
              <div>
                ...
                <div className="text-zinc-400">Technical Articles</div>
              </div>
              <div>
                <div className="text-4xl font-bold text-indigo-400 mb-2">12</div>
                <div className="text-zinc-400">Tech Topics</div>
              </div>
              <div>
                <div className="text-4xl font-bold text-indigo-400 mb-2">4.8</div>
                <div className="text-zinc-400">Average Rating</div>
              </div>
              <div>
                <div className="text-4xl font-bold text-indigo-400 mb-2">Weekly</div>
                <div className="text-zinc-400">Continuous Updates</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-zinc-400">Built by developers, for developers</p>
          </div>
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-zinc-900 rounded-xl shadow-md p-6 text-center border border-zinc-800">
              <div className="w-20 h-20 bg-indigo-500/10 rounded-full mx-auto mb-4 flex items-center justify-center">
                <Icon name="code" size={32} className="text-indigo-400" />
              </div>
              <h3 className="text-xl font-bold text-white mb-2">Technical Editor</h3>
              <p className="text-zinc-400">10 years of frontend development experience, focused on React/TypeScript ecosystem</p>
            </div>
            <div className="bg-zinc-900 rounded-xl shadow-md p-6 text-center border border-zinc-800">
              ...
              <p className="text-zinc-400">Technical writing expert, specializing in simplifying complex concepts into easy-to-understand tutorials</p>
            </div>
            <div className="bg-zinc-900 rounded-xl shadow-md p-6 text-center border border-zinc-800">
              ...
              <p className="text-zinc-400">Jarvis - Automated content collection and quality review</p>
            </div>
          </div>
        </div>
