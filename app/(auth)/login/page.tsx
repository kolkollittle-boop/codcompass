    ...
    <div className="min-h-screen bg-palette-bgPrimary flex items-center justify-center p-4">
      <div className="w-full max-w-md bg-palette-bgCard border border-palette-border rounded-xl p-8 shadow-2xl">
        ...
        <button
          ...
          disabled={loading}
          className="w-full flex items-center justify-center gap-2 bg-white text-zinc-900 font-medium py-3 rounded-lg hover:bg-zinc-100 transition-colors disabled:opacity-50"
        >
        ...
        {error && (
          <p className="mt-4 text-red-400 text-sm bg-red-900/20 p-3 rounded border border-red-800 text-center">
            {error}
          </p>
        )}
